...
export class AddEventComponent implements OnInit, OnDestroy {
  ...
  onsubmit(form: NgForm) {
    ...
    const event = new AMEvent(type, amount, +category, moment().format('DD.MM.YYYY HH:mm:ss'), description);
      ...
      .subscribe((bill: Bill) => {
        ...
        if (type === 'outcome') {
          if (amount > bill.value) {
            this.showMessage(`Not enough money. You should have ${amount - bill.value} more`);
            return;
          } else {
